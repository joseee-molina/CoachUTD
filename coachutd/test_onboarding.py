...
def test_onboard():
    ...
    with client.application.app_context():
        ...
        # change description
        response = client.post('/onboarding', data=dict(age=20, sex="male", availability="friday,saturday", username="Jonathan", password="Hello123"))
        ...
        assert User.query.filter_by(username="Jonathan").first().availability == "friday,saturday"
